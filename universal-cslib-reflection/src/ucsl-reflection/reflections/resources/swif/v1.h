#pragma once
#include <cassert>
#include <ucsl/resources/swif/v1.h>
#include <simple-reflection/simple-reflection.h>
#include <ucsl-reflection/operators.h>
#include <ucsl-reflection/reflections/basic-types.h>

namespace ucsl::resources::swif::v1::reflections {
	using namespace simplerfl;
	using namespace ucsl::reflection;

	namespace impl = ::ucsl::resources::swif::v1;
...
namespace simplerfl {
	template<> struct canonical<ucsl::resources::swif::v1::Rotation3> { using type = ucsl::resources::swif::v1::reflections::Rotation3; };
	template<> struct canonical<ucsl::resources::swif::v1::Color> { using type = ucsl::resources::swif::v1::reflections::Color; };
	template<> struct canonical<ucsl::resources::swif::v1::ECurveType> { using type = ucsl::resources::swif::v1::reflections::ECurveType; };
	template<> struct canonical<ucsl::resources::swif::v1::EInterpolationType> { using type = ucsl::resources::swif::v1::reflections::EInterpolationType; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_KEYFRAME> { using type = ucsl::resources::swif::v1::reflections::SRS_KEYFRAME; };
	template<> struct canonical<ucsl::resources::swif::v1::Key<float>> { using type = ucsl::resources::swif::v1::reflections::Key<float>; };
	template<> struct canonical<ucsl::resources::swif::v1::Key<int>> { using type = ucsl::resources::swif::v1::reflections::Key<int>; };
	template<> struct canonical<ucsl::resources::swif::v1::Key<bool>> { using type = ucsl::resources::swif::v1::reflections::Key<bool>; };
	template<> struct canonical<ucsl::resources::swif::v1::Key<ucsl::resources::swif::v1::Color>> { using type = ucsl::resources::swif::v1::reflections::Key<ucsl::resources::swif::v1::Color>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyLinear<float>> { using type = ucsl::resources::swif::v1::reflections::KeyLinear<float>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyLinear<int>> { using type = ucsl::resources::swif::v1::reflections::KeyLinear<int>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyLinear<bool>> { using type = ucsl::resources::swif::v1::reflections::KeyLinear<bool>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyLinear<ucsl::resources::swif::v1::Color>> { using type = ucsl::resources::swif::v1::reflections::KeyLinear<ucsl::resources::swif::v1::Color>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyHermite<float>> { using type = ucsl::resources::swif::v1::reflections::KeyHermite<float>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyHermite<int>> { using type = ucsl::resources::swif::v1::reflections::KeyHermite<int>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyHermite<bool>> { using type = ucsl::resources::swif::v1::reflections::KeyHermite<bool>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyHermite<ucsl::resources::swif::v1::Color>> { using type = ucsl::resources::swif::v1::reflections::KeyHermite<ucsl::resources::swif::v1::Color>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyIndividual<float>> { using type = ucsl::resources::swif::v1::reflections::KeyIndividual<float>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyIndividual<int>> { using type = ucsl::resources::swif::v1::reflections::KeyIndividual<int>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyIndividual<bool>> { using type = ucsl::resources::swif::v1::reflections::KeyIndividual<bool>; };
	template<> struct canonical<ucsl::resources::swif::v1::KeyIndividual<ucsl::resources::swif::v1::Color>> { using type = ucsl::resources::swif::v1::reflections::KeyIndividual<ucsl::resources::swif::v1::Color>; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_KEYFRAME_PTR> { using type = ucsl::resources::swif::v1::reflections::SRS_KEYFRAME_PTR; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TRACK> { using type = ucsl::resources::swif::v1::reflections::SRS_TRACK; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_MOTION> { using type = ucsl::resources::swif::v1::reflections::SRS_MOTION; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_ANIMATION> { using type = ucsl::resources::swif::v1::reflections::SRS_ANIMATION; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_CROP> { using type = ucsl::resources::swif::v1::reflections::SRS_CROP; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_CROPREF> { using type = ucsl::resources::swif::v1::reflections::SRS_CROPREF; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_DATA::Type> { using type = ucsl::resources::swif::v1::reflections::EDataType; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_DATA_VALUE_PTR> { using type = ucsl::resources::swif::v1::reflections::SRS_DATA_VALUE_PTR; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_DATA> { using type = ucsl::resources::swif::v1::reflections::SRS_DATA; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_USERDATA> { using type = ucsl::resources::swif::v1::reflections::SRS_USERDATA; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TEXTURE> { using type = ucsl::resources::swif::v1::reflections::SRS_TEXTURE; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TEXTURELIST> { using type = ucsl::resources::swif::v1::reflections::SRS_TEXTURELIST; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_CHARACTER_MAPPING> { using type = ucsl::resources::swif::v1::reflections::SRS_CHARACTER_MAPPING; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_FONT> { using type = ucsl::resources::swif::v1::reflections::SRS_FONT; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TEXTDATA> { using type = ucsl::resources::swif::v1::reflections::SRS_TEXTDATA; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_EFFECT> { using type = ucsl::resources::swif::v1::reflections::SRS_EFFECT; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_BLUR> { using type = ucsl::resources::swif::v1::reflections::SRS_BLUR; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_BLUR3D> { using type = ucsl::resources::swif::v1::reflections::SRS_BLUR3D; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_REFLECT> { using type = ucsl::resources::swif::v1::reflections::SRS_REFLECT; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_REFLECT3D> { using type = ucsl::resources::swif::v1::reflections::SRS_REFLECT3D; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TRS_BASE> { using type = ucsl::resources::swif::v1::reflections::SRS_TRS_BASE; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TRS2D> { using type = ucsl::resources::swif::v1::reflections::SRS_TRS2D; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TRS3D> { using type = ucsl::resources::swif::v1::reflections::SRS_TRS3D; };
	//template<> struct canonical<ucsl::resources::swif::v1::SRS_EFFECT_PTR> { using type = ucsl::resources::swif::v1::reflections::SRS_EFFECT_PTR; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_IMAGECAST> { using type = ucsl::resources::swif::v1::reflections::SRS_IMAGECAST; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_SLICE> { using type = ucsl::resources::swif::v1::reflections::SRS_SLICE; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_SLICECAST> { using type = ucsl::resources::swif::v1::reflections::SRS_SLICECAST; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_REFERENCECAST> { using type = ucsl::resources::swif::v1::reflections::SRS_REFERENCECAST; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_CAST_PTR> { using type = ucsl::resources::swif::v1::reflections::SRS_CAST_PTR; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_CASTNODE> { using type = ucsl::resources::swif::v1::reflections::SRS_CASTNODE; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_TRS_PTR> { using type = ucsl::resources::swif::v1::reflections::SRS_TRS_PTR; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_LAYER> { using type = ucsl::resources::swif::v1::reflections::SRS_LAYER; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_CAMERA> { using type = ucsl::resources::swif::v1::reflections::SRS_CAMERA; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_SCENE> { using type = ucsl::resources::swif::v1::reflections::SRS_SCENE; };
	template<> struct canonical<ucsl::resources::swif::v1::SRS_PROJECT> { using type = ucsl::resources::swif::v1::reflections::SRS_PROJECT; };
}