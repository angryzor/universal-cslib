...
namespace ucsl::resources::cemt::v100000::reflections {
	using namespace simplerfl;
	using namespace ucsl::reflection;

	namespace impl = ::ucsl::resources::cemt::v100000;
...
namespace simplerfl {
	template<> struct canonical<ucsl::resources::cemt::v100000::EffectParam> { using type = ucsl::resources::cemt::v100000::reflections::EffectParam; };
}
